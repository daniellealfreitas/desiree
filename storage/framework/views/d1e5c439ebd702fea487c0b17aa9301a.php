...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('Capa'),'subheading' => __('Atualizar sua foto de capa')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Capa')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Atualizar sua foto de capa'))]); ?>
        <form wire:submit.prevent="updateCover" class="my-6 w-full space-y-6">
            <div>
                <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal26c546557cdc09040c8dd00b2090afd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model' => 'cover','label' => __('Capa'),'type' => 'file','accept' => 'image/png, image/jpeg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'cover','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Capa')),'type' => 'file','accept' => 'image/png, image/jpeg']); ?>
...
<?php endif; ?>
                <!--[if BLOCK]><![endif]--><?php if(auth()->user() && auth()->user()->userCoverPhotos()->latest()->first()): ?>
                    <img src="<?php echo e(Storage::url(auth()->user()->userCoverPhotos()->latest()->first()->photo_path)); ?>" alt="Capa" class="mt-4 w-full h-40 rounded">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-message','data' => ['class' => 'me-3','on' => 'cover-updated']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'me-3','on' => 'cover-updated']); ?>
                    <?php echo e(__('Capa atualizada.')); ?>
...
<?php endif; ?>
</section><?php /**PATH C:\xampp\htdocs\desiree2\resources\views\livewire/settings/profile-with-cover.blade.php ENDPATH**/ ?>