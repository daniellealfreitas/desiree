...
<body>
    <main>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Desiree Swing Club" class="img-fluid">
                </a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="ticket.html" class="btn custom-btn d-lg-block d-none">Assinar VIP</a>
              </div>
            </div>
          </nav>
        ...
        <img src="<?php echo e(asset('images/background.jpg')); ?>" class="img-fluid w-100" style="filter: brightness(20%);">
