...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Preenchimento de perfil: <?php echo e($profileCompletion); ?>% <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    <div class="mb-2 flex h-5 overflow-hidden rounded text-xs border border-gray-400 bg-gray-100">
        <div 
            ...
            class="<?php echo e($progressColor); ?> transition-all duration-700 ease-in-out">
        </div>
    </div>
</section><?php /**PATH C:\xampp\htdocs\desiree2\resources\views/livewire/profile-progress-bar.blade.php ENDPATH**/ ?>